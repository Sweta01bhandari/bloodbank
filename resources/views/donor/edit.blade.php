...
<div class="container">
    ...
    <form action="{{ route('donor.update', ['donor' => $donor->id]) }}" method="POST">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="password" name="password" id="password" class="form-control" value="{{ $donor->password }}" required>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" name="mobile" id="mobile" class="form-control" value="{{ $donor->mobile }}" required>
            </div>
        </div>
